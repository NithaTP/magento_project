TC_LOGIN_01	Sign Up	Create a new user account with valid details	Website loads successfully	1. Go to https://magento.softwaretestingboard.com 	Account created and redirected to My Account page	High	Pass
				2. Click on Signup			
